...
import ListofConsultacy from '../ListofConsultacy'
import { Rating, } from 'react-native-ratings';

const ConsultacydetailPage = () => {
            ...
            <View style={styles.main}>
                ...
                <View style={styles.imgborder}>
                  ...
                  <View style={{marginVertical:20}}>
                     <Image source={require('../../ListofConsultacy/ConsultacydetailPage/assets/visa.png')} style={styles.imgvisa} />
                   </View>
                  </TouchableOpacity>
                </View>
...
export default ConsultacydetailPage
