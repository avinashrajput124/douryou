import { ScrollView, StyleSheet, Text, TextInput,Dimensions,FlatList, View, Image, TouchableOpacity, StatusBar } from 'react-native'
      ...
      <ScrollView style={{ flex: 1, backgroundColor: "#fff" }}>
        <View>
          ...
          <View style={styles.main}>
            <View>
              <Image source={require('../../Luggage/assets/sender.png')} style={styles.imagejob} />
            </View>
            <View>
