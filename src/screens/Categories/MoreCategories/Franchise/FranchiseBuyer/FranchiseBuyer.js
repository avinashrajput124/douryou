import { StyleSheet, Text, TextInput, View,Image,Dimensions,FlatList ,StatusBar,ScrollView,TouchableOpacity,} from 'react-native'
import React,{useState} from 'react'


const FranchiseBuyer = () => {
  ...
  const data1 = [
    {
      ...
      Label: "Name:",
      name: 'PrabhJot Singh',
      Labell: 'FrinchiesBuyer:',
      franchiesBuyer: 'First Buyer:'
    },
    {
      id: '2',
      pic: require('../../../../Categories/assets/rose.jpg'),
        ...
        <View>
            ...
            <View>
             ...
             <View style={{flexDirection:'row',justifyContent:'center', marginVertical:30}}>
               <View>
                 <Image source={require('../../Franchise/assets/buyer.png')}  style={styles.imagejob}/>
               </View>
               <View>
